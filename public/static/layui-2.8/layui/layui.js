...
;!function (d) {
    ...
    var t, h = d.document, m = {modules: {}, status: {}, timeout: 10, event: {}}, o = function () {
        ...
        var r = this, e = h.getElementsByTagName("head")[0], i = h.createElement("link"),
            t = ((t = "string" == typeof o ? o : t) || n).replace(/\.|\//g, ""), a = i.id = "layuicss-" + t,
            u = "creating", l = 0;
...
!function (i, g) {
    ...
    var n = i.layui && layui.define, l = {
        ...
        T = "layui-laydate-preview", E = "layui-laydate-shade", S = function (e) {
            var t, a = this,
                n = (a.index = ++v.index, a.config = lay.extend({}, a.config, v.config, e), lay(e.elem || a.config.elem));
...
layui.define("jquery", function (t) {
    "use strict";
    var u = layui.$, d = (layui.hint(), layui.device()), o = "element", c = "layui-this", y = "layui-show",
        s = ".layui-tab-title", i = function () {
            this.config = {}
...
layui.define(["lay", "layer"], function (e) {
    ...
    var y = layui.$, t = layui.layer, F = layui.device(), i = {
        ...
        }, n = "upload", a = "layui-upload-file", o = "layui-upload-form", b = "layui-upload-iframe",
        x = "layui-upload-choose", w = function (e) {
            var t = this;
...
layui.define(["lay", "layer", "util"], function (e) {
    ...
    var b = layui.$, h = layui.layer, d = layui.util, l = layui.hint(), w = (layui.device(), "form"), o = ".layui-form",
        T = "layui-this", $ = "layui-hide", q = "layui-disabled", t = function () {
            this.config = {
                verify: {
                    required: [/[\S]+/, "\u5fc5\u586b\u9879\u4e0d\u80fd\u4e3a\u7a7a"],
                ...
                input: function (e) {
                    ...
                    e.each(function (e, t) {
                        var i = b(this), a = i.attr("lay-skin") || "primary",
                            n = d.escape(b.trim(t.title || (t.title = i.attr("lay-text") || ""))), l = this.disabled,
                        ...
                        s[0] && s.remove(), i.after(t), function (a, n) {
                            var l = b(this);
                            a.on("click", function () {
                                var e = b(this), t = l.attr("lay-filter"),
            ...
            return !(e = b(e))[0] || (e.attr("lay-verify") !== undefined || !1 !== this.validate(e.find("*[lay-verify]"))) && (layui.each(e, function (e, r) {
                var s = b(this), t = (s.attr("lay-verify") || "").split("|"), o = s.attr("lay-vertype"),
                    c = b.trim(s.val());
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (e) {
    "use strict";
    var p = layui.$, c = layui.lay, m = layui.laytpl, O = layui.laypage, f = layui.layer, v = layui.form,
        ...
        o = ".layui-table-header", R = ".layui-table-body", A = ".layui-table-pageview", D = ".layui-table-sort",
        E = "layui-table-edit", W = "layui-table-hover", H = "laytable-cell-group", M = "layui-table-col-special",
        j = "layui-table-tool-panel", S = "LAY_TABLE_MOVE_DICT", a = function (e) {
        ...
        I = p(window), F = p(document), n = function (e) {
            ...
            var t, a, n = this, d = n.config, i = 0, c = 0, r = 0, s = 0, u = n.setInit("width"),
            ...
            var a = this, i = a.config, t = e.res, l = e.curr, n = e.count, o = e.sort, d = t[i.response.dataName] || [],
                t = t[i.response.totalRowName], c = [], r = [], s = [], u = function () {
            ...
            r.totalRow && (layui.each(e, function (e, i) {
                ...
                var a, e = t.field || e, i = o && o[t.field], l = "totalRowDecimals" in t ? t.totalRowDecimals : 2,
                    ...
                    l = (a = t.totalRowText || "", (n = {LAY_COL: t})[e] = l, n = t.totalRow && w.call(c, {
                        item3: t,
                        content: l,
                        tplData: n
                    }) || a, i || n), n = (t.field && c.dataTotal.push({
                        field: t.field,
            ...
            var s = this, u = s.config, c = u.elem.attr("lay-filter"), e = s.layHeader.find("th"), y = ".layui-table-cell",
                o = p("body"), d = {}, r = (s.layTool.on("click", "*[lay-event]", function (e) {
                    ...
                    var e = p(this), t = e.closest("td"), e = e.prev(), a = s.layBody.find('input[name="layTableCheckbox"]'),
                        i = e.parents("tr").eq(0).data("index"), l = e[0].checked,
                    ...
                    var e = p(this), t = e.closest("td"), e = e.prev(), a = e[0].checked,
                    ...
                    var e = p(this), t = e.parent(), a = this.value, i = e.parent().data("field"),
                        e = e.closest("tr").data("index"), e = x.cache[s.key][e], l = r.call(t[0], {
            ...
            return e.each(function () {
                var l, e = p(this), t = e.attr("lay-data"),
                    t = c.options(this, {attr: t ? "lay-data" : null, errorText: d + (t || e.attr("lay-options"))}),
                    n = p.extend({
                        elem: this,
                        cols: [],
                        data: [],
    ...
    x.eachCols = function (e, a, i) {
        ...
        var o, d, i, c, l = (a = "object" == typeof a ? a : (l = {}, a && (l.type = a), l)).type || "csv",
            r = k.that[e], n = k.config[e] || {}, s = {csv: "text/csv", xls: "application/vnd.ms-excel"}[l],
...
layui.define(["table"], function (e) {
    ...
    var E = layui.$, y = layui.form, j = layui.table, u = layui.hint(), a = {}, P = {
        ...
        }, B = "layui-hide", F = ".layui-table-main", q = ".layui-table-fixed-l", Y = ".layui-table-fixed-r",
        p = "layui-table-tree", H = "LAY_DATA_INDEX", h = "LAY_DATA_INDEX_HISTORY", f = "LAY_PARENT_INDEX",
        s = "LAY_CHECKBOX_HALF", R = "LAY_EXPAND", X = "LAY_HAS_EXPANDED", V = "LAY_ASYNC_STATUS", t = function (e) {
            var t = this;
            ...
            t.url ? e && (!r || r.mod) || (a.parseData = function () {
                var e = this, t = arguments, a = t[0],
                    t = ("function" === layui.type(r) && (a = r.apply(e, t) || t[0]), e.response.dataName);
    ...
    var n, z = function (e, t, a) {
        ...
        var e = t.trElem, d = t.tableViewElem || e.closest(".layui-table-view"), r = t.tableId || d.attr("lay-id"),
            o = t.options || j.getOptions(r), e = t.dataIndex || e.attr("lay-data-index"), c = L(r), u = o.tree || {},
            f = u.customName || {}, s = f.isParent, y = c.getNodeDataByIndex(e), p = "boolean" !== layui.type(a),
            h = p ? !y[R] : a, x = y[s] ? h : null;
        if (null === x) return x;
        ...
        var n = this.getOptions(), i = n.elem.next(), l = (i.addClass(p), n.id), d = n.tree || {},
            r = (d.data, d.view || {}), d = d.customName || {}, o = d.isParent, c = i.attr("lay-filter"), u = this,
        ...
        var t = n.config.id, i = L(t), a = n.data = P.getNodeDataByIndex(t, n.index), l = a[H],
...
layui.define(["lay", "util", "element", "form"], function (e) {
    ...
    var _ = layui.$, C = layui.util, w = layui.element, b = layui.form, g = layui.layer, T = {
        ...
        encode: !0,
        copy: !0,
        text: {code: C.escape("</>"), preview: "Preview"}
    }, I = function (e) {
            ...
            var t, l, i, o, n, s, c, d, r, u, y = _(a),
                ...
                v = (E.preview && (a = "LAY-CODE-DF-" + e, r = E.layout || ["code", "preview"], o = "iframe" === E.preview, L = _('<div class="' + T.ELEM_PREVIEW + '">'), d = _('<div class="layui-tab layui-tab-brief">'), n = _('<div class="layui-tab-title">'), u = _('<div class="' + [T.ELEM_ITEM, T.ELEM_ITEM + "-preview", "layui-border"].join(" ") + '">'), s = _('<div class="layui-code-tools"></div>'), m = y.parent("." + T.ELEM_PREVIEW), v = y.prev("." + T.ELEM_TAB), h = y.next("." + T.ELEM_ITEM + "-preview"), E.id && L.attr("id", E.id), L.addClass(E.className), d.attr("lay-filter", a), E.encode = !0, layui.each(r, function (e, a) {
                    ...
                    full: {
                        ...
                        title: ["\u6700\u5927\u5316\u663e\u793a", "\u8fd8\u539f\u663e\u793a"],
                        event: function (e, a) {
                            var i = e.closest("." + T.ELEM_PREVIEW), t = "layui-icon-" + this.className,
                                l = "layui-icon-screen-restore", o = this.title, n = _("html,body"),
                    ...
                    var a = _(this), i = _(e.elem).closest("." + T.ELEM_PREVIEW).find("." + T.ELEM_ITEM),
                        e = i.eq(e.index);
                    i.removeClass(T.ELEM_SHOW), e.addClass(T.ELEM_SHOW), "preview" === a.attr("lay-id") && c(e)
                })), E.ln ? "ol" : "ul"), h = _("<" + v + ' class="layui-code-' + v + '">'),
