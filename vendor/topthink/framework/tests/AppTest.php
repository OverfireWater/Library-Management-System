...
class AppTest extends TestCase
{
    ...
    public function testPath()
    {
        ...
        $appPath = $rootPath . 'app' . DIRECTORY_SEPARATOR . 'index' . DIRECTORY_SEPARATOR;
        ...
        $runtimePath = $rootPath . 'runtime' . DIRECTORY_SEPARATOR . 'index' . DIRECTORY_SEPARATOR;
    ...
    protected function prepareAppForInitialize(vfsStreamDirectory $root, $debug = true)
    {
        ...
        $env->shouldReceive('load')->once()->with($rootPath . '.example..env');
