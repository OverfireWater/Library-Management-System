<?php /*a:1:{s:81:"C:\PHP\WWW\kzy\Library-Management-System\app\book_manage\view\admin\bookInfo.html";i:1684928228;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    layui.use(['table', 'layer', 'form'], function () {
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'seePic') {
                ...
                if (flag){
                    layer.confirm(`当前书籍在${type},您确定要修改状态吗`,function (index){
                        layer.open({
                            type: 2,
                            title: "状态修改",
