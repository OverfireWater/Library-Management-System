<?php /*a:1:{s:74:"D:\phpstudy_pro\WWW\thinkPHP\app\book_manage\view\admin\upPersonalPwd.html";i:1681800826;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    layui.use('form', function () {
        ...
        form.on('submit(formDemo)', function (data) {
            ...
            if (newpwd == enterpwd) {
                ...
                form_data.append("id", <?php echo htmlentities($userInfo['userId']); ?>);
                $.ajax({
                    type: "post",
                    url: "up_pwd",
                    data: form_data,
