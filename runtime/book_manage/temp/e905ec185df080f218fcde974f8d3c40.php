<?php /*a:1:{s:69:"D:\phpstudy_pro\WWW\thinkPHP\app\book_manage\view\login\register.html";i:1683386543;}*/ ?>
<!DOCTYPE html>
...
<div class='login'>
    ...
    <div class='login_fields'>
        <div class='login_fields__user'>
            ...
            <input name="account" placeholder='登陆账号' maxlength="16" id="account" class="username" type='text'
        ...
        <div class='login_fields__password'>
            ...
            <input name="pwd" class="passwordNumder" placeholder='登陆密码' id="pwd" maxlength="16" type='password' autocomplete="off">
        </div>
        <div class='login_fields__user'>
            <div class='icon'>
                <i class="layui-icon layui-icon-user"></i>
            </div>
            <input name="name" placeholder='用户昵称' maxlength="16" id="name" class="username" type='text' autocomplete="off" />
            <div class='validation'>
                <img alt="" src='/static/login/img/tick.png'>
            </div>
        </div>
        ...
        <div class='login_fields__user'>
            ...
            <input name="phone" placeholder="手机号"
                   oninput = "value=value.replace(/[^\d]/g,'')" minlength="11" autocomplete="off" id="phone" maxlength="11" class="username" type='text'  />
            <div class='validation'>
                <img alt="" src='/static/login/img/tick.png'>
            </div>
        </div>
