<?php /*a:1:{s:70:"D:\phpstudy_pro\WWW\thinkPHP\app\book_manage\view\add\addBookInfo.html";i:1683385798;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="cBody">
    <form id="addForm" class="layui-form" method="post" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block ">
                <input type="text" name="author" required lay-verify="required|ZHCheck" value="" placeholder="请键入图书作者"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item" id="dis_none" style="display: none">
            <label class="layui-form-label">捐献人</label>
            <div class="layui-input-block ">
