<?php /*a:1:{s:90:"D:\phpstudy_pro\WWW\Library-Management-System\app\book_manage\view\update\upPressInfo.html";i:1682151834;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <form id="addForm" class="layui-form" method="post" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" required lay-verify="required|ZHCheck" value="<?php echo htmlentities($bookType['PressName']); ?>" placeholder="请输入出版社名称"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block ">
                <textarea name="remark" placeholder="请输入内容" class="layui-textarea" style="height: 200px"><?php echo htmlentities($bookType['remark']); ?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
