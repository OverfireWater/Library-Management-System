<?php /*a:1:{s:83:"D:\phpstudy_pro\WWW\Library-Management-System\app\book_manage\view\admin\index.html";i:1685610729;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
...
<![endif]-->
		...
		<link rel="stylesheet" href="/static/layui-2.8/layui/css/layui.css">
		<style>
			a{
	...
	<body>
		<header class="navbar-wrapper">
			<div class="navbar navbar-fixed-top">
				<div class="container-fluid cl">
					...
					<span class="logo navbar-slogan f-l mr-10 hidden-xs"><?php echo htmlentities($webInfo['webname']); ?></span>
		...
		<aside class="Hui-aside">
			<div class="menu_dropdown bk_2">
				<dl id="menu-data">
					<dt>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a data-href="/index.php/book_manage/admin/book_data" data-title="基本信息" href="javascript:void(0)">网站信息</a></dt>
				</dl>
				<dl id="menu-admin">

					<dt><i class="layui-icon layui-icon-template-1"></i>  图书管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
					<dd>
						<ul>
							<li>
				...
				<dl id="menu-role">
					...
					<dd>
						<ul>
							<li>
								<a data-href="borrower" data-title="借阅人列表" href="javascript:void(0)">用户列表</a>
							</li>
							<li>
				...
				<dl id="menu-lose">
					<dt><i class="layui-icon layui-icon-log"></i> 挂失管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
					<dd>
						<ul>
							<li>
		...
		<section class="Hui-article-box">
			...
			<div id="iframe_box" class="">
				<div class="show_iframe">
					<iframe scrolling="yes" frameborder="0" src="/index.php/book_manage/admin/book_data"></iframe>
				</div>
			</div>
		</section>
		<!--_footer 作为公共模版分离出去-->
