<?php /*a:1:{s:72:"D:\phpstudy_pro\WWW\thinkPHP\app\book_manage\view\update\upBookInfo.html";i:1682675485;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="cBody">
    <form id="addForm" class="layui-form" method="post" action="">
        ...
        <div class="layui-form-item" id="account" style="display: none">
            <label class="layui-form-label" style="color: #e31660">捐献人</label>
            <div class="layui-input-block ">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline shortInput">
                <div class="file_img">
                    ...
                    <button type="button" class="layui-btn" style="margin-top: 5px;" id="file_choose_but">请选择文件</button>
                </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block ">
                <textarea name="remark" placeholder="请输入内容" class="layui-textarea" style="height: 200px"><?php echo htmlentities($bookinfo['SRemark']); ?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
