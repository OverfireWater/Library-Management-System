<?php /*a:1:{s:93:"D:\phpstudy_pro\WWW\Library-Management-System\app\book_manage\view\update\upborrowerInfo.html";i:1685166611;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="cBody">
    <form id="addForm" class="layui-form" method="post" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="cardId" maxlength="18" oninput = "value=value.replace(/[^\d]/g,'')" required lay-verify="required|ZHCheck" value="<?php echo htmlentities($data['BerCardId']); ?>" placeholder="请输入身份证号"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
