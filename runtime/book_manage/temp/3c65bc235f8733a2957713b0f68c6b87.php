<?php /*a:1:{s:67:"D:\phpstudy_pro\WWW\thinkPHP\app\book_manage\view\user\details.html";i:1682587742;}*/ ?>
﻿<!DOCTYPE html>
<html class="no-js">
    ...
    <div class="flex flex-1 flex-col md:px-6 pt-10 " style="margin: 0 6rem" id="content">
        ...
        <div class="hidden px-2 pt-2 md:px-0 flex-wrap order-2 pb-8 js-tab-pane active" id="section-library">
            <div class="flex flex-row sm:flex-col items-center sm:items-start w-full xs:w-1/2 sm:w-1/3 md:w-1/5 p-4 js-book">
                <img src="<?php echo htmlentities($bookInfo['BUrl']); ?>" alt="book-01"
            ...
            <div class="book_text_margin p-4">
                <h2 ><?php echo htmlentities($bookInfo['BName']); ?></h2>
                <br>
                ...
                <div class="book_remark">
                    <?php echo htmlentities($bookInfo['SRemark']); ?>
                </div>
                <div class="border_line"></div>
                ...
                <div>
                    ...
                    <div class="layui-btn layui-btn-radius layui-btn-danger jie_btn" id="Loss">挂失</div>
                </div>
                <?php endif; ?>
    ...
    layui.use(['layer','jquery'], function(){
        ...
        $("#Loss").click(function (){
            $.ajax({
                type: "post",
                url: "user/loss_book",
                data: {"bookNo":<?php echo htmlentities($bookInfo['BNo']); ?>,"borrow":3},
                dataType: "json",
                success:function (res){
                    if (res.code==0){
                        layer.msg(res.msg);
